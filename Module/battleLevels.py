...
class BtlvViewer():
    def __init__(self):
        ...
        if self.goa_btlv:
            ...
            self.regular_rando_visit_rep[locationType.TT] = [twilighttown.CheckLocation.CrystalOrb,twilighttown.CheckLocation.LimitForm,twilighttown.CheckLocation.MansionNobodies]
            ...
            self.regular_rando_visit_rep[locationType.LoD] = [landofdragons.CheckLocation.EncampmentAreaMap,landofdragons.CheckLocation.StormRiderBonus]
            ...
            self.regular_rando_visit_rep[locationType.DC] = [disneycastle.CheckLocation.MinnieEscort,disneycastle.CheckLocation.BoatPete,disneycastle.CheckLocation.BoatPete]
            self.regular_rando_visit_rep[locationType.PR] = [portroyal.CheckLocation.Barbossa,portroyal.CheckLocation.GrimReaper1]
            self.regular_rando_visit_rep[locationType.Agrabah] = [agrabah.CheckLocation.AbuEscort,agrabah.CheckLocation.GenieJafarBonus]
            self.regular_rando_visit_rep[locationType.HT] = [halloweentown.CheckLocation.PrisonKeeper,halloweentown.CheckLocation.Present]
            self.regular_rando_visit_rep[locationType.PL] = [pridelands.CheckLocation.CircleOfLife,pridelands.CheckLocation.Hyenas2]
            self.regular_rando_visit_rep[locationType.SP] = [spaceparanoids.CheckLocation.ScreensBonus,spaceparanoids.CheckLocation.McpBonus]
            ...
            self.reverse_rando_visit_rep[locationType.TT] = [twilighttown.CheckLocation.MansionNobodies,twilighttown.CheckLocation.LimitForm,twilighttown.CheckLocation.CrystalOrb]
            ...
            self.reverse_rando_visit_rep[locationType.LoD] = [landofdragons.CheckLocation.StormRiderBonus,landofdragons.CheckLocation.EncampmentAreaMap]
            ...
            self.reverse_rando_visit_rep[locationType.DC] = [disneycastle.CheckLocation.BoatPete,disneycastle.CheckLocation.MinnieEscort,disneycastle.CheckLocation.MinnieEscort]
            self.reverse_rando_visit_rep[locationType.PR] = [portroyal.CheckLocation.GrimReaper1,portroyal.CheckLocation.Barbossa]
            self.reverse_rando_visit_rep[locationType.Agrabah] = [agrabah.CheckLocation.GenieJafarBonus,agrabah.CheckLocation.AbuEscort]
            ...
            self.reverse_rando_visit_rep[locationType.SP] = [spaceparanoids.CheckLocation.McpBonus,spaceparanoids.CheckLocation.ScreensBonus]
