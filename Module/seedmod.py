...
from Class.openkhmod import ModYml, Bonuses, FormLevels, Items, LevelUps, Messages, PlayerParams, PrizeTable, \
    Treasures, write_yaml_to_zip_file, Asset
...
class SeedModBuilder:
    ...
    def __init__(self, title: str, out_zip: ZipFile):
        ...
        self.mod_yml = ModYml(title, description="Generated by the KH2 Randomizer Seed Generator.")
                ...
                "source": [
                    {
                        ...
                        "source": [
                            {
                                "name": self.messages.source_name,
                                "language": "en"
                            }
                        ]
                    }
                ...
                "source": [
                    {
                        ...
                        "source": [
                            {
                                "name": self.form_levels.source_name,
                                "type": "fmlv"
                            }
                        ]
                    },
                    {
                        ...
                        "source": [
                            {
                                "name": self.level_ups.source_name,
                                "type": "lvup"
                            }
                        ]
                    },
                    ...
                    },
                    {
                        ...
                        "source": [
                            {
                                "name": self.player_params.source_name,
                                "type": "plrp"
                            }
                        ]
                    }
                ...
                "source": [
                    {
                        ...
                        "source": [
                            {
                                "name": self.treasures.source_name,
                                "type": "trsr"
                            }
                        ]
                    },
    ...
    def add_base_messages(self, seed_hash_icons: list[str], crit_mode: bool):
        ...
        seed_hash_string = " ".join(["{:icon " + icon + "}" for icon in seed_hash_icons])
    ...
    def write_as_data_split_assets(self):
        ...
        for as_room in ['hb32', 'hb33', 'hb34', 'hb38']:
            ...
            self.out_zip.write(resource_path(f"static/as_data_split/{script_name}"), source_name)
    ...
    def write_shop_assets(self, modified_shop_binary: bytearray):
        ...
        self.mod_yml.add_asset_source("03system.bin", {
            "name": "shop",
            "type": "unknown41",
            "method": "copy",
            "source": [
    ...
    def write_synth_assets(self, modified_recipes_binary: bytearray, modified_requirements_binary: bytearray):
    ...
    def write_skip_carpet_escape_assets(self):
        ...
        self.out_zip.write(resource_path("static/skip_carpet_escape.script"), source_name)
    ...
    def write_block_shan_yu_skip_assets(self):
        ...
        self.out_zip.write(resource_path("static/disable_shan_yu_skip.script"), source_name)
    ...
    def write_wardrobe_skip_assets(self):
        ...
        self.out_zip.write(resource_path("static/wardrobe/N_BB080_BTL.mset"), source_name)
    ...
    def write_map_skip_assets(self):
        ...
        self.mod_yml.add_assets([
            ...
            },
            {
                ...
                "method": "copy",
                "source": [
                    {"name": libretto_bin_source_name}
                ]
            },
        ])

        self.out_zip.write(resource_path("static/map_skip/ca.yml"), ca_yml_source_name)
        self.out_zip.write(resource_path("static/map_skip/libretto-ca.bar"), libretto_bin_source_name)
    ...
    def write_cmd_list_modifications(self, modified_cmd_list_yml: str):
        ...
        self.out_zip.write(resource_path(f"static/{modified_cmd_list_yml}"), source_name)
    ...
    def write_battle_level_assets(self, modified_battle_level_binary: bytearray):
        ...
        self.mod_yml.add_asset_source("00battle.bin", {
            "method": "copy",
            "name": "btlv",
            "type": "list",
            "source": [
    ...
    def write_better_stt_assets(self, boss_enabled: bool):
        ...
        assets = [
            ...
            # },
            {
                ...
                "method": "copy",
                "source": [
                    {"name": w_ex010_rx_mset_source_name}
                ]
            }
        ]
        if boss_enabled:
            assets.append({
                ...
                "method": "copy",
                "source": [
                    {"name": b_ex100_sr_mset_source_name}
                ]
            })
        self.mod_yml.add_assets(assets)

        self.out_zip.write(resource_path("static/better_stt/trinity_zz.bar"), trinity_bar_source_name)
        self.out_zip.write(resource_path("static/better_stt/B_EX100.mset"), b_ex100_mset_source_name)
        self.out_zip.write(resource_path("static/better_stt/F_TT010.mset"), f_tt010_mset_source_name)
        self.out_zip.write(resource_path("static/better_stt/P_EX110.mset"), p_ex110_mset_source_name)
        self.out_zip.write(resource_path("static/better_stt/W_EX010_RX.mset"), w_ex010_rx_mset_source_name)
        # out_zip.write(resource_path("static/better_stt/ObjList_Better_STT.yml"), objlist_yml_source_name)
        if boss_enabled:
            self.out_zip.write(resource_path("static/better_stt/B_EX100_SR.mset"), b_ex100_sr_mset_source_name)

    def write_chest_visuals_assets(self, chest_assignments: list[ChestVisualAssignment]):
        ...
        for spawn_file_path, visual_assignments in chest_assignments_by_file.items():
            with(open(resource_path(f"static/chests/ard/{spawn_file_path}.spawn"))) as spawn_file:
                spawn_data = yaml.safe_load(spawn_file)

            for visual_assignment in visual_assignments:
                chest_index = visual_assignment.chest_index
                spawn_data[0]["Entities"][chest_index]["ObjectId"] = visual_assignment.chest_visual_id
        ...
        self.out_zip.write(resource_path('static/chests/remastered/trash.dds'), trash_source_name)
        self.out_zip.write(resource_path('static/chests/remastered/abilities.dds'), abilities_source_name)
        self.out_zip.write(resource_path('static/chests/remastered/forms.dds'), forms_source_name)
        self.out_zip.write(resource_path('static/chests/remastered/magic.dds'), magic_source_name)
        self.out_zip.write(resource_path('static/chests/remastered/pages.dds'), pages_source_name)
        self.out_zip.write(resource_path('static/chests/remastered/reports.dds'), reports_source_name)
        self.out_zip.write(resource_path('static/chests/remastered/stats.dds'), stats_source_name)
        self.out_zip.write(resource_path('static/chests/remastered/summons.dds'), summons_source_name)
        self.out_zip.write(resource_path('static/chests/remastered/unlocks.dds'), unlocks_source_name)
        self.out_zip.write(resource_path('static/chests/remastered/weapons.dds'), weapons_source_name)
        self.out_zip.write(resource_path('static/chests/remastered/proofs_glow.dds'), proofs_glow_source_name)
        self.out_zip.write(resource_path('static/chests/remastered/proofs.dds'), proofs_source_name)

        # Listpatch
        chest_obj_list_source_name = _relative_mod_file('chest/ChestObjList.yml')
        self.out_zip.write(resource_path('static/chests/ChestObjList.script'), chest_obj_list_source_name)
        ...
        self.out_zip.write(resource_path('static/chests/obj/F_EX030_LK.mset'), f_ex030_lk_source_name)
        self.out_zip.write(resource_path('static/chests/obj/F_EX040_LK.mset'), f_ex040_lk_source_name)
        self.out_zip.write(resource_path('static/chests/obj/F_EX040_RX.mset'), f_ex040_rx_source_name)
        ...
        self.out_zip.write(resource_path('static/chests/obj/F_EX030_JNK.mdlx'), jnk_source_name)
        self.out_zip.write(resource_path('static/chests/obj/F_EX030_ABL.mdlx'), abl_source_name)
        self.out_zip.write(resource_path('static/chests/obj/F_EX030_FRM.mdlx'), frm_source_name)
        self.out_zip.write(resource_path('static/chests/obj/F_EX030_MAG.mdlx'), mag_source_name)
        self.out_zip.write(resource_path('static/chests/obj/F_EX030_PAG.mdlx'), pag_source_name)
        self.out_zip.write(resource_path('static/chests/obj/F_EX030_REP.mdlx'), rep_source_name)
        self.out_zip.write(resource_path('static/chests/obj/F_EX030_STA.mdlx'), sta_source_name)
        self.out_zip.write(resource_path('static/chests/obj/F_EX030_SMN.mdlx'), smn_source_name)
        self.out_zip.write(resource_path('static/chests/obj/F_EX030_VST.mdlx'), vst_source_name)
        self.out_zip.write(resource_path('static/chests/obj/F_EX030_WEP.mdlx'), wep_source_name)
        self.out_zip.write(resource_path('static/chests/obj/F_EX040_PRF.mdlx'), prf_source_name)

    def validate_and_write_mod_yml(self, zip_data: io.BytesIO, settings: RandomizerSettings) -> io.BytesIO:
        ...
        for modded_file in self.mod_yml.find_assets("03system.bin"):
            for source_index, source in enumerate(modded_file["source"]):
                if source["name"] == "cmd":
                    listpatch_file_paths.append(source["source"][0]["name"].replace("\\", "/"))
        ...
        if len(listpatch_file_paths) > 1:
            with ZipFile(zip_data, "r") as current_zip:
                for listpatch_file_path in listpatch_file_paths:
                    ...
                    with path.open(encoding="UTF-8") as current_listpatch_file:
                        listpatch_contents.extend(yaml.safe_load(current_listpatch_file))
            ...
            for asset_index, asset in enumerate(mod_data["assets"]):
                ...
                if asset["name"] == "03system.bin":
                    ...
                    asset["source"] = [
                        src for src_index, src in enumerate(asset["source"]) if src_index not in delete_source_indices
                    ]
            ...
            if num_03system_entries > 1:
                mod_data["assets"] = [
                    asset for a_index, asset in enumerate(mod_data["assets"]) if a_index not in delete_asset_indices
                ]
            ...
            self.mod_yml.add_asset_source("03system.bin", {
                ...
                "source": [
                    {
                        "name": merged_command_list_source,
                        "type": "cmd"
                    }
                ]
            })
            ...
            for asset_index, asset in enumerate(mod_data["assets"]):
                if asset["name"] == modded_file:
                    if first_asset_index:
                        ...
                        mod_data["assets"][first_asset_index]["source"] += asset["source"]
                    else:
        ...
        with ZipFile(zip_data, "a", ZIP_DEFLATED) as current_zip:
            ...
            if len(listpatch_contents) > 0:
                write_yaml_to_zip_file(current_zip, merged_command_list_source, listpatch_contents, sort_keys=False)
    ...
    def _add_prize_table_asset(self):
        self.mod_yml.add_asset_source("00battle.bin", {
            ...
            "source": [
                {
                    "name": self.prize_table.source_name,
                    "type": "przt"
                }
            ]
        })
    ...
    def _get_chest_visual_assets() -> list[Asset]:
        ...
        # ARD edits
        for room_1 in ['al00', 'al01', 'al06', 'al07', 'al10', 'al11', 'al12', 'al13',
                ...
                "source": [
                    {
                        ...
                        "method": "spawnpoint",
                        "source": [
                            {"name": _relative_mod_file("chest/ard/" + room_1 + "/m_70.yml")}
                        ]
                    }
                ],
            })

        for room_2 in ['bb12', 'hb05', 'hb06', 'hb26', 'tt09', 'tt10', 'tt15', 'tt16', 'tt17', 'tt22']:
            assets.append({
                "name": "ard/" + room_2 + ".ard",
                "multi": [
                ...
                "source": [
                    {
                        ...
                        "method": "spawnpoint",
                        "source": [
                            {"name": _relative_mod_file("chest/ard/" + room_2 + "/m_70.yml")}
                        ]
                    },
                    {
                        "name": "m_71",
                        ...
                        "method": "spawnpoint",
                        "source": [
                            {"name": _relative_mod_file("chest/ard/" + room_2 + "/m_71.yml")}
                        ]
                    }
                ],
            })

        for room_3 in ['tt07', 'tt13', 'tt14', 'tt25', 'tt26', 'tt27', 'tt28', 'tt36', 'tt37']:
            assets.append({
                "name": "ard/" + room_3 + ".ard",
                "multi": [
                ...
                "source": [
                    {
                        ...
                        "method": "spawnpoint",
                        "source": [
                            {"name": _relative_mod_file("chest/ard/" + room_3 + "/m_71.yml")}
                        ]
                    }
                ],
            })
        ...
        for basic_type_suffix, _ in basic_types.items():
            assets.append({
                ...
                "method": "copy",
                "source": [
                    {"name": _relative_mod_file(f"chest/obj/F_EX030_{basic_type_suffix}.mdlx")}
                ],
            })
        # Proofs
        assets.append({
            ...
            "method": "copy",
            "source": [
                {"name": _relative_mod_file("chest/obj/F_EX040_PRF.mdlx")}
            ],
        })
        ...
        assets.append({
            ...
            "method": "copy",
            "source": [
                {"name": _relative_mod_file("chest/obj/F_EX030_LK.mset")}
            ],
        })
        # PL Big Chest
        assets.append({
            ...
            "method": "copy",
            "source": [
                {"name": _relative_mod_file("chest/obj/F_EX040_LK.mset")}
            ],
        })
        ...
        assets.append({
            ...
            "method": "copy",
            "source": [
                {"name": _relative_mod_file("chest/obj/F_EX040_RX.mset")}
            ],
        })
        ...
        for basic_type_suffix, basic_type_name in basic_types.items():
            assets.append({
                ...
                "method": "copy",
                "source": [
                    {"name": _relative_mod_file(f"chest/remastered/{basic_type_name}.dds")}
                ],
            })
        # Proofs
        assets.append({
        ...
        assets.append({
            ...
            "method": "copy",
            "source": [
                {"name": _relative_mod_file("chest/remastered/proofs.dds")}
            ],
        })
