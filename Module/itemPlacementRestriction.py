...
RestrictedConfig = namedtuple("RestrictedConfig","treasures bonuses forms")
...
class ItemPlacementRestriction():
    ...
    def get_restriction_functions(self):
        return RestrictedConfig(self.treasure_restriction_function,self.bonus_restriction_function,self.form_restriction_function)