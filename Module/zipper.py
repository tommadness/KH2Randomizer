...
from Class.openkhmod import ATKPObject, AttackEntries, AttackEntriesOrganizer, ModYml, write_objects_into_yaml
    ...
    def create_zip(self) -> io.BytesIO:
        ...
        with ZipFile(data, "w", ZIP_DEFLATED) as out_zip:
            ...
            if(self.donald_changed):
                ...
                #Now add to/create yaml file...
                attack_list = [ground_sequence_1, ground_sequence_2_2, ground_sequence_2_2, air_sequence_1, air_sequence_2, fire_1, fire_2, blizzard, thunder]
            ...
            if(self.goofy_changed):
                ...
                attack_list = [ground_sequence_1, ground_sequence_1, passive_shield_1, passive_shield_2, air_sequence_1, air_sequence_2, bash, turbo, tornado]
                for attack in attack_list: organizer.convert_atkp_object_to_dict_and_add_to_data(attack)
