...
def _add_cosmetics(
    ...
    mod_yml.add_assets(CosmeticsMod.randomize_field2d(extra_data))
...
class SeedZip:
    ...
    def create_zip(self) -> SeedZipResult:
        ...
        with ZipFile(zip_data, "w", ZIP_DEFLATED) as out_zip:
            ...
            _add_cosmetics(out_zip=out_zip, mod_yml=mod.mod_yml, extra_data=extra_data, settings=settings.ui_settings)
...
class CosmeticsOnlyZip:
    ...
    def create_zip(self) -> io.BytesIO:
        ...
        with ZipFile(data, "w", ZIP_DEFLATED) as out_zip:
            ...
            _add_cosmetics(out_zip=out_zip, mod_yml=mod, extra_data=self.extra_data, settings=self.settings)
