...
class SeedZip:
    ...
    def create_zip(self) -> SeedZipResult:
        ...
        with ZipFile(zip_data, "w", ZIP_DEFLATED) as out_zip:
            ...
            mod.mod_yml.add_assets(commandmenu.randomize_command_menus(extra_data.command_menu_choice))
...
class CosmeticsOnlyZip:
    ...
    def create_zip(self) -> io.BytesIO:
        ...
        with ZipFile(data, "w", ZIP_DEFLATED) as out_zip:
            ...
            mod.add_assets(commandmenu.randomize_command_menus(self.extra_data.command_menu_choice))
