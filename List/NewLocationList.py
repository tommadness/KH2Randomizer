...
class Locations:
    ...
    def makeStartingGraph(self):
        self.add_node("Starting",LocationNode([KH2Location(i, f"Starting Item {i}", locationCategory.CHEST, [locationType.Critical]) for i in range(1,8)] + \
                                                ...
                                                KH2Location(590, "Proof of Nonexistence", locationCategory.CHEST,[locationType.Free], VanillaItems=[594]),
                                                ]))
    ...
    def makeLoDGraph(self):
        ...
        self.add_node("Village Cave Bonus",LocationNode([KH2Location(43, "Village Cave Bonus", locationCategory.ITEMBONUS,[locationType.LoD],VanillaItems=[264]),]))
        ...
        self.add_node("Shan-Yu",LocationNode([KH2Location(9, "Shan-Yu", locationCategory.HYBRIDBONUS,[locationType.LoD],VanillaItems=[269]),
                                         KH2Location(257, "Hidden Dragon", locationCategory.POPUP,[locationType.LoD],VanillaItems=[481]),]))
        self.add_node("Throne Room",LocationNode([KH2Location(25, "Throne Room Torn Pages", locationCategory.CHEST,[locationType.LoD],VanillaItems=[32]),
        ...
        self.add_node("Storm Rider",LocationNode([KH2Location(10, "Storm Rider", locationCategory.ITEMBONUS,[locationType.LoD],VanillaItems=[23]),]))
    ...
    def makeAGGraph(self):
        ...
        self.add_node("Abu Escort",LocationNode([KH2Location(42, "Abu Escort", locationCategory.ITEMBONUS,[locationType.Agrabah],VanillaItems=[399]),]))
        ...
        self.add_node("Elemental Lords",LocationNode([KH2Location(37, "Elemental Lords", locationCategory.ITEMBONUS,[locationType.Agrabah],VanillaItems=[267]),
                                         KH2Location(300, "Lamp Charm", locationCategory.POPUP,[locationType.Agrabah],VanillaItems=[159]),]))
        self.add_node("Ruined Chamber",LocationNode([KH2Location(34, "Ruined Chamber Torn Pages", locationCategory.CHEST,[locationType.Agrabah],VanillaItems=[32]),
                                         KH2Location(486, "Ruined Chamber Ruins Map", locationCategory.CHEST,[locationType.Agrabah]),]))
        self.add_node("Genie Jafar",LocationNode([KH2Location(15, "Genie Jafar", locationCategory.ITEMBONUS,[locationType.Agrabah],VanillaItems=[21]),
                                         KH2Location(303, "Wishing Lamp", locationCategory.POPUP,[locationType.Agrabah],VanillaItems=[492]),]))
    ...
    def makeDCGraph(self):
        ...
        self.add_node("Library",LocationNode([KH2Location(91, "Library Torn Pages", locationCategory.CHEST,[locationType.DC],VanillaItems=[32]),]))
        self.add_node("Library Popup",LocationNode([KH2Location(332, "Disney Castle Map", locationCategory.POPUP,[locationType.DC]),]))
        self.add_node("Minnie Escort",LocationNode([KH2Location(38, "Minnie Escort", locationCategory.HYBRIDBONUS,[locationType.DC],VanillaItems=[389]),]))
        ...
        self.add_node("Boat Pete",LocationNode([KH2Location(16, "Boat Pete", locationCategory.ITEMBONUS,[locationType.DC],VanillaItems=[263]),]))
        self.add_node("Future Pete",LocationNode([KH2Location(17, "Future Pete", locationCategory.HYBRIDBONUS,[locationType.DC],VanillaItems=[88]),
                                        KH2Location(261, "Monochrome", locationCategory.POPUP,[locationType.DC],VanillaItems=[485]),]))
        self.add_node("Wisdom Popup",LocationNode([KH2Location(262, "Wisdom Form", locationCategory.POPUP,[locationType.DC],VanillaItems=[27]),]))
    ...
    def makeHundredAcreGraph(self):
        ...
        self.add_node("Spooky Cave",LocationNode([KH2Location(110, "Spooky Cave Mythril Gem", locationCategory.CHEST,[locationType.HUNDREDAW]),
                                        ...
                                        KH2Location(284, "Sweet Memories", locationCategory.POPUP,[locationType.HUNDREDAW],VanillaItems=[495]),
        ...
        self.add_node("Starry Hill",LocationNode([KH2Location(312, "Starry Hill Cosmic Ring", locationCategory.CHEST,[locationType.HUNDREDAW]),
                                        ...
                                        KH2Location(285, "Starry Hill Cure Element", locationCategory.POPUP,[locationType.HUNDREDAW],VanillaItems=[24]),
    ...
    def makeOCGraph(self):
        ...
        self.add_node("Cerberus Bonus",LocationNode([KH2Location(5, "Cerberus", locationCategory.ITEMBONUS,[locationType.OC],VanillaItems=[268]),]))
        self.add_node("Coliseum Map Popup",LocationNode([KH2Location(338, "Coliseum Map", locationCategory.POPUP,[locationType.OC]),]))
        self.add_node("Urns Bonus",LocationNode([KH2Location(57, "Urns", locationCategory.ITEMBONUS,[locationType.OC],VanillaItems=[560]),]))
        ...
        self.add_node("Demyx (OC)",LocationNode([KH2Location(58, "Demyx OC", locationCategory.STATBONUS,[locationType.OC]),
                                        KH2Location(529, "Secret Ansem Report 5", locationCategory.POPUP,[locationType.OC],VanillaItems=[230]),
        ...
        self.add_node("Pete (OC)",LocationNode([KH2Location(6, "Pete (OC)", locationCategory.ITEMBONUS,[locationType.OC],VanillaItems=[198]),]))
        self.add_node("Hydra",LocationNode([KH2Location(7, "Hydra", locationCategory.HYBRIDBONUS,[locationType.OC],VanillaItems=[23]),
                                        KH2Location(260, "Hero's Crest", locationCategory.POPUP,[locationType.OC],VanillaItems=[484]),]))
        self.add_node("Auron Statue",LocationNode([KH2Location(295, "Auron's Statue", locationCategory.POPUP,[locationType.OC]),]))
        self.add_node("Hades",LocationNode([KH2Location(8, "Hades", locationCategory.HYBRIDBONUS,[locationType.OC],VanillaItems=[561]),
                                        KH2Location(272, "Guardian Soul", locationCategory.POPUP,[locationType.OC],VanillaItems=[491]),]))
        ...
        self.add_node("Goddess of Fate Cup",LocationNode([KH2Location(516, "Fatal Crest (Goddess of Fate Cup)", locationCategory.POPUP,[locationType.OC, locationType.OCCups], InvalidChecks=[itemType.TROPHY],VanillaItems=[497]),
    ...
    def makeBCGraph(self):
        ...
        self.add_node("West Hall",LocationNode([KH2Location(41, "The West Hall Hi-Potion", locationCategory.CHEST,[locationType.BC]),
                                        ...
                                        KH2Location(208, "The West Hall Mythril Shard (2)", locationCategory.CHEST,[locationType.BC]),
        ...
        self.add_node("West Hall Post Dungeon",LocationNode([KH2Location(158, "The West Hall AP Boost (Post Dungeon)", locationCategory.CHEST,[locationType.BC]),]))
        ...
        self.add_node("Dark Thorn",LocationNode([KH2Location(3, "Dark Thorn Bonus", locationCategory.HYBRIDBONUS,[locationType.BC],VanillaItems=[273]),
                                        KH2Location(299, "Dark Thorn Cure Element", locationCategory.POPUP,[locationType.BC],VanillaItems=[24]),]))
        self.add_node("Rumbling Rose",LocationNode([KH2Location(270, "Rumbling Rose", locationCategory.POPUP,[locationType.BC],VanillaItems=[490]),
                                        KH2Location(325, "Castle Walls Map", locationCategory.POPUP,[locationType.BC]),]))
        self.add_node("Xaldin",LocationNode([KH2Location(4, "Xaldin Bonus", locationCategory.HYBRIDBONUS,[locationType.BC],VanillaItems=[88]),
                                        KH2Location(528, "Secret Ansem Report 4", locationCategory.POPUP,[locationType.BC],VanillaItems=[229]),]))
    ...
    def makeSPGraph(self):
        ...
        self.add_node("Hostile Program",LocationNode([KH2Location(31, "Hostile Program", locationCategory.HYBRIDBONUS,[locationType.SP],VanillaItems=[562]),]))
        self.add_node("Photon Debugger",LocationNode([KH2Location(267, "Photon Debugger", locationCategory.POPUP,[locationType.SP],VanillaItems=[488]),]))
        self.add_node("Solar Sailer Bonus",LocationNode([KH2Location(61, "Solar Sailer", locationCategory.ITEMBONUS,[locationType.SP],VanillaItems=[266]),]))
        ...
        self.add_node("MCP Bonus",LocationNode([KH2Location(32, "MCP", locationCategory.HYBRIDBONUS,[locationType.SP],VanillaItems=[88]),]))
    ...
    def makeHTGraph(self):
        ...
        self.add_node("Prison Keeper",LocationNode([KH2Location(18, "Prison Keeper", locationCategory.HYBRIDBONUS,[locationType.HT],VanillaItems=[559]),]))
        self.add_node("Oogie Boogie",LocationNode([KH2Location(19, "Oogie Boogie", locationCategory.STATBONUS,[locationType.HT]),
                                        KH2Location(301, "Oogie Boogie Magnet Element", locationCategory.POPUP,[locationType.HT],VanillaItems=[87]),]))
        ...
        self.add_node("Experiment",LocationNode([KH2Location(20, "Experiment", locationCategory.STATBONUS,[locationType.HT]),
                                        KH2Location(275, "Decisive Pumpkin", locationCategory.POPUP,[locationType.HT],VanillaItems=[493]),]))
    ...
    def makePRGraph(self):
        ...
        self.add_node("Boat Fight",LocationNode([KH2Location(62, "Boat Fight", locationCategory.ITEMBONUS,[locationType.PR],VanillaItems=[270]),]))
        ...
        self.add_node("Barbossa",LocationNode([KH2Location(21, "Barbossa", locationCategory.HYBRIDBONUS,[locationType.PR],VanillaItems=[272]),
                                        KH2Location(263, "Follow the Wind", locationCategory.POPUP,[locationType.PR],VanillaItems=[486]),]))
        self.add_node("Grim Reaper 1",LocationNode([KH2Location(59, "Grim Reaper 1", locationCategory.ITEMBONUS,[locationType.PR],VanillaItems=[271]),]))
        self.add_node("Interceptor's Hold",LocationNode([KH2Location(252, "Interceptor's Hold Feather Charm", locationCategory.CHEST,[locationType.PR],VanillaItems=[160]),]))
        ...
        self.add_node("Grim Reaper 2",LocationNode([KH2Location(22, "Grim Reaper 2", locationCategory.ITEMBONUS,[locationType.PR],VanillaItems=[87]),
                                        KH2Location(530, "Secret Ansem Report 6", locationCategory.POPUP,[locationType.PR],VanillaItems=[231]),]))
    ...
    def makeHBGraph(self):
        ...
        self.add_node("Merlin's House Popup",LocationNode([KH2Location(256, "Merlin's House Membership Card", locationCategory.POPUP,[locationType.HB],VanillaItems=[369]),
                                        KH2Location(292, "Merlin's House Blizzard Element", locationCategory.POPUP,[locationType.HB],VanillaItems=[22]),]))
        self.add_node("Bailey",LocationNode([KH2Location(47, "Bailey", locationCategory.ITEMBONUS,[locationType.HB],VanillaItems=[21]),
                                        KH2Location(531, "Bailey Secret Ansem Report 7", locationCategory.POPUP,[locationType.HB],VanillaItems=[232]),]))
        self.add_node("Baseball Charm Popup",LocationNode([KH2Location(258, "Baseball Charm", locationCategory.POPUP,[locationType.HB],VanillaItems=[383]),]))
        ...
        self.add_node("DTD Popup",LocationNode([KH2Location(266, "Ansem's Study Master Form", locationCategory.POPUP,[locationType.HB],VanillaItems=[31]),
                                        KH2Location(276, "Ansem's Study Sleeping Lion", locationCategory.POPUP,[locationType.HB],VanillaItems=[494]),]))
        ...
        self.add_node("Ukulele Charm",LocationNode([KH2Location(183, "Ansem's Study Ukulele Charm", locationCategory.CHEST,[locationType.HB],VanillaItems=[25]),]))
        ...
        self.add_node("Demyx (HB)",LocationNode([KH2Location(28, "Demyx (HB)", locationCategory.HYBRIDBONUS,[locationType.HB],VanillaItems=[22]),]))
        self.add_node("Final Fantasy Fights",LocationNode([KH2Location(361, "FF Fights Cure Element", locationCategory.POPUP,[locationType.HB],VanillaItems=[24]),]))
        self.add_node("Crystal Fissure",LocationNode([KH2Location(179, "Crystal Fissure Torn Pages", locationCategory.CHEST,[locationType.HB],VanillaItems=[32]),
        ...
        self.add_node("1000 Heartless",LocationNode([KH2Location(60, "1000 Heartless", locationCategory.ITEMBONUS,[locationType.HB],VanillaItems=[265]),
                                        KH2Location(525, "1000 Heartless Secret Ansem Report 1", locationCategory.POPUP,[locationType.HB],VanillaItems=[226]),
    ...
    def makePLGraph(self):
        ...
        self.add_node("Oasis",LocationNode([KH2Location(412, "Oasis Map", locationCategory.CHEST,[locationType.PL]),
                                        KH2Location(493, "Oasis Torn Pages", locationCategory.CHEST,[locationType.PL],VanillaItems=[32]),
                                        KH2Location(413, "Oasis AP Boost", locationCategory.CHEST,[locationType.PL]),]))
        self.add_node("Circle of Life",LocationNode([KH2Location(264, "Circle of Life", locationCategory.POPUP,[locationType.PL],VanillaItems=[487]),]))
        ...
        self.add_node("Scar",LocationNode([KH2Location(29, "Scar", locationCategory.STATBONUS,[locationType.PL]),
                                        KH2Location(302, "Scar Fire Element", locationCategory.POPUP,[locationType.PL],VanillaItems=[21]),]))
        self.add_node("Hyenas 2 Bonus",LocationNode([KH2Location(50, "Hyenas 2", locationCategory.STATBONUS,[locationType.PL]),]))
        self.add_node("Groundshaker",LocationNode([KH2Location(30, "Groundshaker", locationCategory.HYBRIDBONUS,[locationType.PL],VanillaItems=[23]),]))
    ...
    def makeSTTGraph(self):
        ...
        self.add_node("Munny Pouch Popup",LocationNode([KH2Location(288, "Munny Pouch (Olette)", locationCategory.POPUP,[locationType.STT],VanillaItems=[362]),]))
        self.add_node("Roxas Station",LocationNode([KH2Location(54, "Station Dusks", locationCategory.ITEMBONUS,[locationType.STT],VanillaItems=[158]),
        ...
        self.add_node("Twilight Thorn",LocationNode([KH2Location(33, "Twilight Thorn", locationCategory.ITEMBONUS,[locationType.STT],VanillaItems=[82]),]))
        self.add_node("Axel 1",LocationNode([KH2Location(73, "Axel 1", locationCategory.ITEMBONUS,[locationType.STT],VanillaItems=[138]),]))
    ...
    def makeTTGraph(self):
        ...
        self.add_node("Station Fight Popup",LocationNode([KH2Location(526, "Station Plaza Secret Ansem Report 2", locationCategory.POPUP,[locationType.TT],VanillaItems=[227]),
                                        KH2Location(290, "Munny Pouch (Mickey)", locationCategory.POPUP,[locationType.TT],VanillaItems=[535]),
        ...
        self.add_node("Valor Form",LocationNode([KH2Location(304, "Star Seeker", locationCategory.POPUP,[locationType.TT],VanillaItems=[480]),
                                        KH2Location(286, "Valor Form", locationCategory.POPUP,[locationType.TT],VanillaItems=[26]),]))
        self.add_node("Seifer's Trophy",LocationNode([KH2Location(294, "Seifer´s Trophy", locationCategory.POPUP,[locationType.TT]),]))
        self.add_node("Limit Form",LocationNode([KH2Location(265, "Oathkeeper", locationCategory.POPUP,[locationType.TT],VanillaItems=[42]),
                                        KH2Location(543, "Limit Form", locationCategory.POPUP,[locationType.TT],VanillaItems=[563]),]))
        ...
        self.add_node("TT Beam",LocationNode([KH2Location(534, "Beam Secret Ansem Report 10", locationCategory.POPUP,[locationType.TT],VanillaItems=[235]),]))
        ...
        self.add_node("Betwixt and Between",LocationNode([KH2Location(63, "Betwixt and Between", locationCategory.ITEMBONUS,[locationType.TT],VanillaItems=[262]),
                                        KH2Location(317, "Betwixt and Between Bond of Flame", locationCategory.POPUP,[locationType.TT],VanillaItems=[498]),]))
    ...
    def makeTWTNWGraph(self):
        ...
        self.add_node("Roxas",LocationNode([KH2Location(69, "Roxas", locationCategory.HYBRIDBONUS,[locationType.TWTNW],VanillaItems=[539]),
                                            KH2Location(532, "Roxas Secret Ansem Report 8", locationCategory.POPUP,[locationType.TWTNW],VanillaItems=[233]),
                                            KH2Location(277, "Two Become One", locationCategory.POPUP,[locationType.TWTNW],VanillaItems=[543]),]))
        ...
        self.add_node("Xigbar",LocationNode([KH2Location(23, "Xigbar Bonus", locationCategory.STATBONUS,[locationType.TWTNW]),
                                              KH2Location(527, "Xigbar Secret Ansem Report 3", locationCategory.POPUP,[locationType.TWTNW],VanillaItems=[228]),]))
        ...
        self.add_node("Oblivion",LocationNode([KH2Location(278, "Oblivion", locationCategory.POPUP,[locationType.TWTNW],VanillaItems=[43]),
                                            KH2Location(496, "Castle That Never Was Map", locationCategory.POPUP,[locationType.TWTNW]),]))
        self.add_node("Luxord",LocationNode([KH2Location(24, "Luxord Bonus", locationCategory.HYBRIDBONUS,[locationType.TWTNW],VanillaItems=[87]),
                                               KH2Location(533, "Luxord Secret Ansem Report 9", locationCategory.POPUP,[locationType.TWTNW],VanillaItems=[234]),]))
        self.add_node("Saix",LocationNode([KH2Location(25, "Saix Bonus", locationCategory.STATBONUS,[locationType.TWTNW]),
                                               KH2Location(536, "Saix Secret Ansem Report 12", locationCategory.POPUP,[locationType.TWTNW],VanillaItems=[237]),]))
        self.add_node("Pre-Xemnas 1 Popup",LocationNode([KH2Location(535, "(Pre-Xemnas 1) Secret Ansem Report 11", locationCategory.POPUP,[locationType.TWTNW],VanillaItems=[236]),]))
        ...
        self.add_node("Xemnas 1",LocationNode([KH2Location(26, "Xemnas 1 Bonus", locationCategory.DOUBLEBONUS, [locationType.TWTNW]),
                                              KH2Location(537, "Xemnas 1 Secret Ansem Report 13", locationCategory.POPUP,[locationType.TWTNW],VanillaItems=[238]),]))
    ...
    def makeATLGraph(self):
        ...
        self.add_node("Ursula",LocationNode([KH2Location(287, "Mysterious Abyss", locationCategory.POPUP,[locationType.Atlantica],VanillaItems=[496]),]))
        self.add_node("New Day is Dawning",LocationNode([KH2Location(279, "Musical Blizzard Element", locationCategory.POPUP,[locationType.Atlantica],VanillaItems=[22]),
