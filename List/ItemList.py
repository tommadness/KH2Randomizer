...
class Items:
    ...
    def getItemList(story_unlocking_rarity = itemRarity.UNCOMMON):
        return [
            ...
            KH2Item(54, "Battlefields of War (Key Lock)", itemType.STORYUNLOCK, story_unlocking_rarity),
            KH2Item(55, "Sword of the Ancestor (Key Lock)", itemType.STORYUNLOCK, story_unlocking_rarity),
            KH2Item(59, "Beast's Claw (Key Lock)", itemType.STORYUNLOCK, story_unlocking_rarity),
            KH2Item(60, "Bone Fist (Key Lock)", itemType.STORYUNLOCK, story_unlocking_rarity),
            KH2Item(61, "Proud Fang (Key Lock)", itemType.STORYUNLOCK, story_unlocking_rarity),
            KH2Item(62, "Skill and Crossbones (Key Lock)", itemType.STORYUNLOCK, story_unlocking_rarity),
            KH2Item(72, "Scimitar (Key Lock)", itemType.STORYUNLOCK, story_unlocking_rarity),
            # KH2Item(73, "Way to the Dawn (Riku)", itemType.STORYUNLOCK, story_unlocking_rarity),
            KH2Item(74, "Identity Disk (Key Lock)", itemType.STORYUNLOCK, story_unlocking_rarity),
            # KH2Item(365, "Tournament Poster", itemType.STORYUNLOCK, story_unlocking_rarity),
            KH2Item(369, "Membership Card (Key Lock)", itemType.STORYUNLOCK, story_unlocking_rarity),
            KH2Item(375, "Ice Cream (Key Lock)", itemType.STORYUNLOCK,story_unlocking_rarity),
            KH2Item(376, "Picture (Key Lock)", itemType.STORYUNLOCK,story_unlocking_rarity),
