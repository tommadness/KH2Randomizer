...
def _sample_first_visit_nodes() -> list[str]:
    ...
    return [
        ...
        hollowbastion.NodeId.BoroughChests,
        hollowbastion.NodeId.Bailey,
        hollowbastion.NodeId.BaseballCharmPopup,
        landofdragons.NodeId.BambooGroveChests,
        ...
        beastscastle.NodeId.EastWingChests,
        beastscastle.NodeId.WestHallChests,
        beastscastle.NodeId.BeastBonus,
        beastscastle.NodeId.DarkThorn,
        olympuscoliseum.NodeId.PassageChests,
        ...
        agrabah.NodeId.CaveOfWondersEntranceChests,
        agrabah.NodeId.TreasureRoomChests,
        agrabah.NodeId.ElementalLords,
        halloweentown.NodeId.GraveyardChests,
        halloweentown.NodeId.CandyCaneLaneChests,
        halloweentown.NodeId.PrisonKeeper,
        halloweentown.NodeId.OogieBoogie,
        pridelands.NodeId.GorgeChests,
        pridelands.NodeId.WildebeestValleyChests,
        pridelands.NodeId.Hyenas1Bonus,
        pridelands.NodeId.Scar,
        spaceparanoids.NodeId.PitCellChests,
...
def _sample_second_visit_nodes() -> list[str]:
    ...
    """
    return [
        hollowbastion.NodeId.AnsemsStudyChests,
        hollowbastion.NodeId.CorMiningAreaChests,
        hollowbastion.NodeId.ThousandHeartless,
        hollowbastion.NodeId.TransportToRemembrance,
        twilighttown.NodeId.LimitForm,
        twilighttown.NodeId.UndergroundConcourseChests,
        twilighttown.NodeId.MansionBasementChests,
        twilighttown.NodeId.BetwixtAndBetween,
        landofdragons.NodeId.ThroneRoomChests,
        ...
        agrabah.NodeId.RuinedChamberChests,
