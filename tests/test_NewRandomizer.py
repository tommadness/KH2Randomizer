...
class Tests(unittest.TestCase):
    def test_constructingRandomizer(self):
        ...
        self.assertEqual(randomizer.levelStats[0].experience,40/2)
        self.assertEqual(randomizer.levelStats[-1].experience,2875578/2)
        ...
        self.assertEqual(num_str_increase+num_mag_increase+num_def_increase+num_ap_increase,174)
