...
treasureList = [
    ...
    KH2Treasure(105, "Piglet's House Defense Boost", locationTypes=["100AW"]),
    KH2Treasure(103, "Piglet's House AP Boost", locationTypes=["100AW"]),
    KH2Treasure(104, "Piglet's House Mythril Gem", locationTypes=["100AW"]),
    KH2Treasure(314, "Rabbit's House Draw Ring", locationTypes=["100AW"]),
    KH2Treasure(100, "Rabbit's House Mythril Crystal", locationTypes=["100AW"]),
    KH2Treasure(101, "Rabbit's House AP Boost", locationTypes=["100AW"]),
    KH2Treasure(108, "Kanga's House Magic Boost", locationTypes=["100AW"]),
    KH2Treasure(106, "Kanga's House AP Boost", locationTypes=["100AW"]),
    KH2Treasure(107, "Kanga's House Orichalcum", locationTypes=["100AW"]),
    KH2Treasure(110, "The Spooky Cave Mythril Gem", locationTypes=["100AW"]),
    KH2Treasure(111, "The Spooky Cave AP Boost", locationTypes=["100AW"]),
    KH2Treasure(112, "The Spooky Cave Orichalcum", locationTypes=["100AW"]),
    KH2Treasure(113, "The Spooky Cave Guard Recipe", locationTypes=["100AW"]),
    KH2Treasure(115, "The Spooky Cave Mythril Crystal", locationTypes=["100AW"]),
    KH2Treasure(116, "The Spooky Cave AP Boost", locationTypes=["100AW"]),
    KH2Treasure(312, "Starry Hill Cosmic Ring", locationTypes=["100AW"]),
