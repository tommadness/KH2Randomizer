...
3. Extract OpenKH Mods Manager to this folder 
4. Place the Seed Generator in own folder as well
...
3. In the **"Add a new mod from GitHub"** section, type in the account name and mod name. This will download a mod from its hosted GitHub repository
...
3. Once saved, open up the Mods Manager and click on **"Mods"**, then **"Install a New Mod"**
...
2. Recommended to set FPS limit to **60**.
3. Recommended to run game in Windowed/Borderless Fullscreen mode. Fullscreen is stable but the game can crash if you alt-tab out.
